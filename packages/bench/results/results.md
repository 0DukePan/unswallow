...
fp-guard-discussion-only | vllm | 0.19.0 | — | none | no | 0.00 | PASS
fp-guard-partial-json | vllm | 0.19.0 | — | none | no | 0.00 | PASS
...
vllm-qwen3-0.24-clean | vllm | 0.24.0 | A | none | no | 0.00 | PASS
...
**15/15 fixtures passing** — fixtures are hash-pinned (see `fixtures.sha256`); engine/version hints per fixture; every `source` is cited in the fixture file. Matrix↔fixture consistency: 9/9.
